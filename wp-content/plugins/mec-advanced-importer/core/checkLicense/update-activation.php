<?php
namespace MEC_Advanced_Importer\Core\checkLicense;
 ...
 * @since       1.0.0
 */
class AdvancedImporterAddonUpdateActivation
{
     ...
     * @access  public
     */
    public $option_string = MECADVANCEDIMPORTEROPTIONS;
     ...
     * @access  public
     */
    public $license_status_string = MECADVANCEDIMPORTERTEXTDOMAIN . 'license_status';
     ...
     * @access  public
     */
    public $reActivation_string = MECADVANCEDIMPORTERTEXTDOMAIN . 'reActivationOption';
     ...
     * @access  public
     */
    public $text_domain_string = MECADVANCEDIMPORTERTEXTDOMAIN;
     ...
     * @access  public
     */
    public $name_string = MEC_ADVANCED_IMPORTER_NAME;
     ...
     * @access  public
     */
    public $slug_string = MECADVANCEDIMPORTERSLUG;
     ...
     * @access  public
     */
    public $main_file_path = MECADVANCEDIMPORTERMAINFILEPATH;
    ...
    public static function setHooks($This){
        ...
        add_action(	'wp_ajax_activate_Addons_Integration_ADVIMPORTER', array($This, 'activate_Addons_Integration_ADVIMPORTER'));
    }
            ...
            if (jQuery("#'.$this->text_domain_string.'").length > 0)
            {
                jQuery("#'.$this->text_domain_string.' input[type=submit]").on("click", function(e){
                    ...
                    jQuery.ajax({
                        ...
                        type: "POST",
                        data: {
                            action: "activate_Addons_Integration_ADVIMPORTER",
    ...
    public function activate_Addons_Integration_ADVIMPORTER() {
    ...
    public function load_auto_update() {
        ...
        require_once MECADVANCEDIMPORTERPABSPATH.'/core/checkLicense/puc/plugin-update-checker.php';
