...
<div id="general_option" class="mec-options-fields active">
      ...
      <p class="description"><?php esc_html_e( 'For each repetition a separate event is created and importing past events is not possible', 'mec-advanced-importer'); ?></p>
      ...
      <div class="mec-form-row">
         ...
         <div class="mec-col-4">
            ...
            <select id="mec-advimp-importby-inp">
               ...
               <option value="single">
                  <?php _e('Meetup Event ID','mec-advanced-importer'); ?>
               </option>
               <option value="group">
                  <?php _e('Meetup Group','mec-advanced-importer'); ?>
               </option>
            </select>
      ...
      <div class="mec-form-row  mec-advimp-import-option mec-advinp-dnone" id="mec-advimp-importby-single">
         <label class="mec-col-3" for="mec-advimp-importby-single-inp">
            <?php _e('Meetup Event IDs','mec-advanced-importer'); ?>
         </label>
         <div class="mec-col-4">
            ...
            <span class="mec-tooltip">
               <div class="box">
                  ...
                  <div class="content">
                     <p>
                        <?php _e('One event ID per line, ( Eg. Event ID for https://www.meetup.com/events/123456789/ is "123456789" ).','mec-advanced-importer'); ?>
                     </p>
                  </div>
               </div>
               <i title="" class="dashicons-before dashicons-editor-help"></i>
      ...
      <div class="mec-form-row mec-advimp-import-option mec-advinp-dnone" id="mec-advimp-importby-group">
         <label class="mec-col-3" for="mec-advimp-importby-group-inp">
            <?php _e('Meetup Group ID','mec-advanced-importer'); ?>
         </label>
         <div class="mec-col-4">
            ...
            <span class="mec-tooltip">
               <div class="box">
                  <h5 class="title">
                     <?php _e('Meetup Group URL / Numeric ID to fetch events from','mec-advanced-importer'); ?>
                  </h5>
                  <div class="content">
                     <p>
                        <?php _e('Eg.Input value for https://www.meetup.com/groups/123456789123456/ OR "123456789123456"','mec-advanced-importer'); ?>
                     </p>
                  </div>
               </div>
               <i title="" class="dashicons-before dashicons-editor-help"></i>
...
<div class="mec-options-fields">
      ...
      <div class="mec-form-row mec-messages">
         ...
         <?php
         $list = \MEC_Advanced_Importer\Core\Lib\MEC_Advanced_Importer_Main::active_account('meetup',true);
         if($list == null){
         ...
         <div class="mec-col-12">
            <button style="margin: 0px;" data-url="<?php echo $getall; ?>" data-action="getall" data-section="meetup" class="button button-primary mec-button-primary mec-advimp-action" type="button" id="mec-advimp-getallevent">
               <?php _e('Get All Events','mec-advanced-importer'); ?>
            </button>
            <button style="margin: 0px;" data-url="<?php echo $add_to_auto_sync; ?>" data-action="add-to-schedule" data-section="meetup" class="button button-primary mec-button-primary mec-advimp-action" type="button" id="mec-advimp-add-to-sync">
               <?php _e('Add to auto sync','mec-advanced-importer'); ?>
            </button>
            <input type="hidden" value="meetup-calendar-import-start">
...
<?php elseif( 'sync' === $ctab ): ?>
   ...
   <form id="advimp-sync-table" method="post">
      <?php MEC_Advanced_Importer_Sync::display_sync_table_list( 'meetup' ); ?>
