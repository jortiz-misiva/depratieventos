  ...
  <div id="general_option" class="mec-options-fields active">
      ...
      <div class="mec-form-row  mec-advimp-import-option mec-advinp-dnone" id="mec-advimp-importby-single">
         <label class="mec-col-3" for="mec-advimp-importby-single-inp">
            <?php _e('Eventbrite Event IDs','mec-advanced-importer'); ?>
         </label>
         <div class="mec-col-4">
            ...
            <span class="mec-tooltip">
               <div class="box">
                  ...
                  <div class="content">
                     <p>
                        <?php _e('One event ID per line, ( Eg. Event ID for https://www.mecsite.com/events/123456789/ is "123456789" ).','mec-advanced-importer'); ?>
                     </p>
                  </div>
               </div>
               <i title="" class="dashicons-before dashicons-editor-help"></i>
...
<div class="mec-options-fields">
      ...
      <div class="mec-form-row mec-messages">
         ...
         <?php
         $list = \MEC_Advanced_Importer\Core\Lib\MEC_Advanced_Importer_Main::active_account('mecapi');
         if($list == null){
         ...
         <div class="mec-col-12">
            <button style="margin: 0px;" data-url="<?php echo $getall; ?>" data-action="getall" data-section="mecapi" class="button button-primary mec-button-primary mec-advimp-action" type="button" id="mec-advimp-getallevent">
               <?php _e('Get All Events','mec-advanced-importer'); ?>
            </button>
            <button style="margin: 0px;" data-url="<?php echo $add_to_auto_sync; ?>" data-action="add-to-schedule" data-section="mecapi" class="button button-primary mec-button-primary mec-advimp-action" type="button" id="mec-advimp-add-to-sync">
               <?php _e('Add to auto sync','mec-advanced-importer'); ?>
            </button>
            <input type="hidden" value="mecapi-calendar-import-start">
...
<?php elseif( 'sync' === $ctab ): ?>
   ...
   <form id="advimp-sync-table" method="post">
      <?php MEC_Advanced_Importer_Sync::display_sync_table_list( 'mecapi' ); ?>
