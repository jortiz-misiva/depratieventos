...
<input type="hidden" id="mec-advimp-call-getall" value="MEC_ADVIMP_Clear_Google_Query">
...
<?php if($ctab=='fetch'): ?>
   <div id="general_option" class="mec-options-fields active">
      ...
      <div class="mec-form-row">
         <label class="mec-col-3" for="mec-advimp-add-account-as-category">
            <?php _e('Add Calender Title as Category','mec-advanced-importer'); ?>
         </label>
         <div class="mec-col-4">
            <label for="mec-advimp-import-calendar-as-category"><input type="checkbox" id="mec-advimp-add-account-as-category" value="1" /><?php esc_html_e( 'Enable', 'mec-advanced-importer' ) ?></label>
         </div>
      </div>
      ...
      <div class="mec-form-row">
         ...
         <div class="mec-col-4">
            ...
            <select id="mec-advimp-importby-inp">
               ...
               <option value="group">
                  <?php _e('Group','mec-advanced-importer'); ?>
               </option>
            </select>
         ...
         <div class="mec-col-4">
            ...
            <span class="mec-tooltip">
               <div class="box">
                  ...
                  <div class="content">
                     <p>
                        <?php _e('One event ID per line, ( Eg. Event ID for https://www.google.com/events/123456789/ is "123456789" ).','mec-advanced-importer'); ?>
                     </p>
                  </div>
               </div>
               <i title="" class="dashicons-before dashicons-editor-help"></i>
         ...
         <div class="mec-col-4">
            ...
            <span class="mec-tooltip">
               <div class="box">
                  ...
                  <div class="content">
                     <p>
                        <?php _e('Eg. username for https://www.google.com/webnus/ is "webnus".','mec-advanced-importer'); ?>
                     </p>
                  </div>
               </div>
               <i title="" class="dashicons-before dashicons-editor-help"></i>
         ...
         <div class="mec-col-4">
            ...
            <span class="mec-tooltip">
               <div class="box">
                  ...
                  <div class="content">
                     <p>
                        <?php _e('Eg.Input value for https://www.google.com/groups/123456789123456/
https://www.google.com/groups/123456789123456/ OR "123456789123456"','mec-advanced-importer'); ?>
                     </p>
                  </div>
               </div>
               <i title="" class="dashicons-before dashicons-editor-help"></i>
      ...
      <div class="mec-form-row">
       ...
       <div class="mec-form-row">
         <label class="mec-col-3" for="mec-advimp-import-sdate"><?php _e('Start Date', 'mec-advanced-importer'); ?></label>
         <div class="mec-col-4">
             <input type="text" id="mec-advimp-import-sdate" value="<?php echo  date('Y-m-d', strtotime('-1 Month')); ?>" class="mec_date_picker" />
         </div>
     </div>
     <div class="mec-form-row">
         <label class="mec-col-3" for="mec-advimp-import-edate"><?php _e('End Date', 'mec-advanced-importer'); ?></label>
         <div class="mec-col-4">
             <input type="text" id="mec-advimp-import-edate" value="<?php echo date('Y-m-d', strtotime('+3 Months')); ?>" class="mec_date_picker" />
         </div>
     </div>
     <div class="mec-form-row">
         <label class="mec-col-3" for="mec-advimp-import-linkmore"><?php _e('Load More Link', 'mec-advanced-importer'); ?></label>
         <div class="mec-col-4">
            <label for="mec-advimp-import-linkmore"><input type="checkbox" id="mec-advimp-import-linkmore" value="1" /><?php esc_html_e( 'Link to main event', 'mec-advanced-importer' ) ?></label>
         </div>
     </div>
     <div class="mec-form-row">
         <label class="mec-col-3" for="mec-advimp-import-update"><?php _e('Update', 'mec-advanced-importer'); ?></label>
         <div class="mec-col-4">
            <label for="mec-advimp-import-update"><input type="checkbox" id="mec-advimp-import-update" value="1" /><?php esc_html_e( 'Update existing events in sync', 'mec-advanced-importer' ) ?></label>
         </div>
     </div>
   </div>
<div class="mec-options-fields">
      ...
      <div class="mec-form-row mec-messages">
         <?php
         $status = null;
         $list = \MEC_Advanced_Importer\Core\Lib\MEC_Advanced_Importer_Main::active_account('google',true,null,null,$status);
         echo $status;
         if($list == null){
         ...
         <div class="mec-col-4">
       <button style="margin: 0px;" data-url="<?php echo $getall; ?>" data-action="getall" data-section="google" class="button button-primary mec-button-primary mec-advimp-action" type="button" id="mec-advimp-getallevent">
            <?php _e('Get All Events','mec-advanced-importer'); ?>
         </button>
         <input type="hidden" value="google-calendar-import-start">
...
<?php elseif( 'sync' === $ctab ): ?>
   ...
   <form id="advimp-sync-table" method="post">
      <?php MEC_Advanced_Importer_Sync::display_sync_table_list( 'google' ); ?>
