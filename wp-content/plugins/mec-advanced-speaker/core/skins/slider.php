<div class="mec-advanced-speaker">
    <div class="mec-wrap mec-skin-grid-container mec-featured-border mec-advanced-speaker-slider">
        <input type="hidden" class="mec-advanced-speaker-slider-isup" value="yes">
        <div class="mec-skin-grid-events-container mec-event-article" >
            <div class="mec-wrap ">
                <?php if( !empty( $skin->data ) ): ?>
                    <div class="mec-event-speaker-grid mec-event-speaker-slider mec-featured-sidebar">
                        <?php
                        foreach($skin->data as $d){
                            $meta = \MEC_Advanced_Speaker\Core\Lib\MEC_Advanced_Speaker_Lib_Factory::get_meta_key_val($d->term_id,$skin->atts['exclude_details']);
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <div class="mec-featured-info-box">
                                        <span class="mec-featured-box-top mec-featured-box-top-single featured-grid  mec-featured-slider mec-advanced-speaker-featured-custom <?php echo $atts['html_option'];?>"><?php _e('FEATURED','mec-advanced-speaker'); ?></span>
                                        ...
                                        <p class="mec-featured-info">
                                            ...
                                            <span class="mec-featured-info-box-title">
                                                ...
                                                <em><?php _e('Ongoing Events:','mec-advanced-speaker'); ?></em>
                                        ...
                                        <div class="mec-feature-view-details">
                                            <span class="mec-feature-view-details-left"><a class="mec-events-gcal mec-events-button mec-color mec-bg-color-hover mec-border-color mec-featured-none-decoration featured-event-button" href="<?php echo $link; ?>" target="<?php echo $link_target; ?>">
                                                ...
                                                echo sprintf(
                                                    ...
                                                    \MEC\Base::get_main()->m('taxonomy_speaker', __('Speaker', 'mec-advanced-speaker'))
                                                );
                                                ?>
                                            </a></span>
                ...
                <?php else: ?>
                    <div class="mec-skin-slider-no-speaker-container" id="mec_featured_skin_no_events_<?php echo $skin->id; ?>">
                        <?php _e('No speaker found!', 'mec-advanced-speaker'); ?>
                    </div>
                <?php endif; ?>
            </div>
        </div>
