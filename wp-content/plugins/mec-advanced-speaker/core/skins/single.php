        ...
        <div class="mec-single-event-description mec-events-content">
            <div class="mec-wrap mec-skin-list-container">
                <div class="mec-featured-wrap mec-skin-list-events-container">
                    <div class="mec-wrap">
                        <div class="mec-featured-top-title mec-featured-speaker">
                            <article data-style="" class="mec-event-article  mec-clear  mec-divider-toggle" itemscope="">
                                <div class="mec-event-image mec-featured-image"><?php if(isset($meta['thumbnail']) && !empty($meta['thumbnail'])): ?><a data-event-id="5" href="#"><img width="200" height="200" src="<?php echo $meta['thumbnail']; ?>" class="attachment-full size-full wp-post-image" alt="" loading="lazy" data-mec-postid="32" srcset="<?php echo $meta['thumbnail']; ?> 300w, <?php echo $meta['thumbnail']; ?> 150w" sizes="(max-width: 200px) 100vw, 200px"></a><?php endif; ?></div>
                                <div class="mec-featured-info-box">
                                    <?php if(isset($featured) && $featured==true): ?><span class="mec-featured-box-top-single"><?php _e('FEATURED','mec-advanced-speaker'); ?></span><?php endif; ?>
                                    <?php if(isset($term['name']) && !empty($term['name'])): ?><h2><?php echo ucfirst($term['name']); ?></h2><?php endif; ?>
                                    <?php if(isset($meta['job_title']) && !empty($meta['job_title'])&& strlen($meta['job_title'])>0): ?>
                                    <span class="mec-featured-job-title"><?php echo ucfirst($meta['job_title']); ?></span>
                                    <?php endif; ?>
                                    ...
                                    <div class="mec-social-networks"><?php
                                ...
                                <?php if(isset($term['description']) && !empty($term['description'])): ?>
                                    <h3 class="mec-featured-about-single">
                                        <?php _e('About','mec-advanced-speaker'); ?>
                                        <?php echo $SKO->main->m('taxonomy_speaker', __('Speaker', 'mec-advanced-speaker')); ?>
                                    </h3>
                ...
                <div class="mec-speaker-shortcode">
                    <?php echo $SKO->output(); ?>
                </div>
                <?php endif; ?>
            </div>
