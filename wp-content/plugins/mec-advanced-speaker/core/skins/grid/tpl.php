...
<div class="mec-featured-wrap mec-wrap mec-skin-grid-container <?php echo $this->html_class; ?>" id="mec_advanced_speaker_skin_<?php echo $this->id; ?>">

    <?php if($this->found): ?>

    <div class="mec-skin-grid-events-container" id="mec_advanced_speaker_skin_events_<?php echo $this->id; ?>">
        <?php echo $items_html; ?>
    </div>
