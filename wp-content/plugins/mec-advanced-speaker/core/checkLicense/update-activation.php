<?php
namespace MEC_Advanced_Speaker\Core\checkLicense;
 ...
 * @since       1.0.0
 */
class AdvancedSpeakerAddonUpdateActivation
{
     ...
     * @access  public
     */
    public $option_string = MEC_ADVANCED_SPEAKER_OPTIONS;
     ...
     * @access  public
     */
    public $license_status_string = MEC_ADVANCED_SPEAKER_TEXTDOMAIN . 'license_status';
     ...
     * @access  public
     */
    public $reActivation_string = MEC_ADVANCED_SPEAKER_TEXTDOMAIN . 'reActivationOption';
     ...
     * @access  public
     */
    public $text_domain_string = MEC_ADVANCED_SPEAKER_TEXTDOMAIN;
     ...
     * @access  public
     */
    public $name_string = MEC_ADVANCED_SPEAKER_NAME;
     ...
     * @access  public
     */
    public $slug_string = MEC_ADVANCED_SPEAKER_SLUG;
     ...
     * @access  public
     */
    public $main_file_path = MEC_ADVANCED_SPEAKER_MAINFILEPATH;
    ...
    public static function setHooks($This){
        ...
        add_action(	'wp_ajax_activate_Addons_Integration_Advanced_Speaker', array($This, 'activate_Addons_Integration_Advanced_Speaker'));
    }
            ...
            if (jQuery("#'.$this->text_domain_string.'").length > 0)
            {
                jQuery("#'.$this->text_domain_string.' input[type=submit]").on("click", function(e){
                    ...
                    jQuery.ajax({
                        ...
                        type: "POST",
                        data: {
                            action: "activate_Addons_Integration_Advanced_Speaker",
    ...
    public function activate_Addons_Integration_Advanced_Speaker() {
        ...
        {
            $LicenseStatus = __('Activation failed. Please check your purchase code or license type.<br><b>Note: Your purchase code should match your licesne type.</b>', 'mec-advanced-speaker') . '<a style="text-decoration: underline; padding-left: 7px;" href="https://webnus.net/dox/modern-events-calendar/auto-update-issue/" target="_blank">'  . __('Troubleshooting', 'mec-advanced-speaker') . '</a>';
            update_option($this->license_status_string, 'faild');
        }
    ...
    public function load_auto_update() {
        ...
        require_once MEC_ADVANCED_SPEAKER_PABSPATH.'/core/checkLicense/puc/plugin-update-checker.php';
