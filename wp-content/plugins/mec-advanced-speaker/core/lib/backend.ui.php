 ...
 */
class MEC_Advanced_Speaker_Lib_Backend_UI {
	...
	private static function init($class) {
		...
		if( class_exists( \MEC\ImportExport\Terms::class ) ) {
			...
			new \MEC\ImportExport\Terms( 'mec_speaker' );
		}
	}
	...
	public static function edit_checkbox($term) {
        ...
        <tr class="form-field">
            <th scope="row">
                <label for="mec_featured"><?php _e('Featured', 'mec-advanced-speaker');?></label>
            </th>
            <td>
	...
	public static function add_checkbox() {
		...
		<div class="form-field">
            <label for="mec_featured" class="featured_addon_checbox_label"><?php _e('Featured', 'mec-advanced-speaker');?></label>
	...
	public static function load_assets($class) {
		...
		wp_enqueue_style('mec-featured-addon-style', MEC_ADVANCED_SPEAKER_ASSETS . 'css/backend.css');
		return true;
	}

	public static function add_setting_menu($menus) {
		$title = sprintf(__('Advanced %s', 'mec-advanced-speaker'),self::$main->m('taxonomy_speaker', __('Speaker', 'mec-advanced-speaker')));

		$menus[$title] = 'advanced_speaker_option';
		return $menus;
	}

	public static function setting_menu_content($settings) {
		$main = self::$main;
		$ui = MEC_ADVANCED_SPEAKER_DIR . 'core' . DS . 'lib' . DS . 'settings.ui.php';
		include $ui;
	}
}
