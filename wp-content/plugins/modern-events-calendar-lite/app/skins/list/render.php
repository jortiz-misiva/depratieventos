		...
		<?php foreach($this->events as $date=>$events): ?>
            ...
            <article class="<?php echo (isset($event->data->meta['event_past']) and trim($event->data->meta['event_past'])) ? 'mec-past-event ' : ''; ?>mec-event-article <?php echo esc_attr($custom_data_class); ?> mec-clear <?php echo esc_attr($this->get_event_classes($event)); ?> mec-divider-toggle mec-toggle-<?php echo date('Ym', strtotime($date)); ?>-<?php echo esc_attr($this->id); ?>" itemscope>
                ...
                <?php elseif($this->style == 'classic'): ?>
                    <div class="mec-event-image"><?php echo MEC_kses::element($this->display_link($event, $event->data->thumbnails['full'])); ?></div>
                    ...
                    <?php 
                        ...
                        ?>
                    <div class="btn-fecha"><?php echo $fechaFormateada; ?></div>
                    <div class="btn-hora"> De <?php echo $horainicio ?> a <?php echo $horafin ?> </div>
                    <div class="btn-lugar">
                   ...
                   /** no direct access **/
                    ...
                    // echo "<p>Fecha fin:".$start_time."</p>";
                    // echo "<p>Fecha fin:".$end_time."</p>";
                    // die;
                    $zonaHoraria = "America/Guayaquil";  // Ejemplo de zona horaria
                    // Convertir las fechas locales a UTC para Google Calendar
                  ...
                  ?>
                    <div class="btn-agenda-evento" data-ref="<?php echo $event->ID?>">Agregar a calendario</div>                    
                    <?php if(isset($settings['sn']['googlecal'])){?>
                     <div class="btn-cal-google-<?php echo $event->ID?> ocultar-grid"> 
                                    <a class="mec-events-gcal mec-events-button mec-color mec-bg-color-hover mec-border-color" 
                                        href="<?php echo $url1; ?>" target="_blank">
                                        Google
                                    </a>
                     </div>
                    <?php }?>
                    <?php if(isset($settings['sn']['ical'])){ ?>
                      <div class="btn-cal-ios-<?php echo $event->ID?> ocultar-grid">
                                <a class="mec-events-gcal mec-events-button mec-color mec-bg-color-hover mec-border-color" 
                                href="<?php echo $url2 ?>">
                                    iCal / Outlook export
                                </a>
                    ...
                    <?php echo MEC_kses::element($this->display_link($event,'Conoce más')); ?>    
                    </div>                    
