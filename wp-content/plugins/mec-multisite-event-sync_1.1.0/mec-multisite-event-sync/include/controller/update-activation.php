 ...
 * @since       1.0.0
 */
class MultisiteAddonUpdateActivation
{
     ...
     * @access  public
     */
    public $option_string = MEC_SYNC_OPTIONS;
     ...
     * @access  public
     */
    public $license_status_string = MEC_SYNC_TEXT_DOMAIN . 'license_status';
     ...
     * @access  public
     */
    public $reActivation_string = MEC_SYNC_TEXT_DOMAIN . 'reActivationOption';
     ...
     * @access  public
     */
    public $text_domain_string = MEC_SYNC_TEXT_DOMAIN;
     ...
     * @access  public
     */
    public $name_string = MEC_SYNC_ORG_NAME;
     ...
     * @access  public
     */
    public $slug_string = MEC_SYNC_SLUG;
     ...
     * @access  public
     */
    public $main_file_path = MEC_SYNC_MAINFILEPATH;
    ...
    public static function setHooks($This){
        ...
        add_action(	'wp_ajax_activate_Addons_Integration_Multisite', array($This, 'activate_Addons_Integration_Multisite'));
    }
            ...
            if (jQuery("#'.$this->text_domain_string.'").length > 0)
            {
                jQuery("#'.$this->text_domain_string.' input[type=submit]").on("click", function(e){
                    ...
                    jQuery.ajax({
                        ...
                        type: "POST",
                        data: {
                            action: "activate_Addons_Integration_Multisite",
    ...
    public function activate_Addons_Integration_Multisite() {
    ...
    public function load_auto_update() {
        ...
        require_once MEC_SYNC_PABSPATH.'/include/controller/puc/plugin-update-checker.php';
...
new MultisiteAddonUpdateActivation();