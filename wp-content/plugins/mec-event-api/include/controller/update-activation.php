 ...
 * @since       1.0.0
 */
class APIAddonUpdateActivation
{
     ...
     * @access  public
     */
    public $option_string = API_PLUGIN_OPTIONS;
     ...
     * @access  public
     */
    public $license_status_string = API_PLUGIN_TEXT_DOMAIN . 'license_status';
     ...
     * @access  public
     */
    public $reActivation_string = API_PLUGIN_TEXT_DOMAIN . 'reActivationOption';
     ...
     * @access  public
     */
    public $text_domain_string = API_PLUGIN_TEXT_DOMAIN;
     ...
     * @access  public
     */
    public $name_string = API_PLUGIN_ORG_NAME;
     ...
     * @access  public
     */
    public $slug_string = API_PLUGIN_SLUG;
     ...
     * @access  public
     */
    public $main_file_path = API_PLUGIN_MAIN_FILE_PATH;
    ...
    public static function setHooks($This){
        ...
        add_action(	'wp_ajax_activate_Addons_Integration_EVENT_API', array($This, 'activate_Addons_Integration_EVENT_API'));
    }
                ...
                if (jQuery("#'.$this->text_domain_string.'").length > 0)
                {
                    jQuery("#'.$this->text_domain_string.' input[type=submit]").on("click", function(e){
                        ...
                        jQuery.ajax({
                            ...
                            type: "POST",
                            data: {
                                action: "activate_Addons_Integration_EVENT_API",
    ...
    public function activate_Addons_Integration_EVENT_API() {
    ...
    public function load_auto_update() {
        ...
        require_once API_PLUGIN_ABSPATH.'/include/controller/puc/plugin-update-checker.php';
