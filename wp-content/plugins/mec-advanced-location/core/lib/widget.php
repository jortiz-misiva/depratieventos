...
/**
 * Adds Location widget.
 */
class MEC_Advanced_Location_Lib_Widget extends \WP_Widget {
    ...
    public function __construct() {
        ...
        $title_t = $main->m('taxonomy_location', __('Location', 'mec-advanced-location'));

        $title = sprintf(__('Advanced %s Widget','mec-advanced-location'),$title_t);

        parent::__construct(
            'featured_location_widget',
            $title,
    ...
    public function widget( $args, $instance ) {
        ...
        $widget = new \MEC_Advanced_Location\Core\LocationWidget\MEC_Advanced_Location_LocationWidget_Frontend();

        echo $widget->location_featured_content(array(
    ...
    public function form( $instance ) {
        if ( isset( $instance[ 'title' ] ) ) {
            ...
            $title = __('New title','mec-advanced-location');
        }
         ...
         <p>
          ...
          <p>
            <label for="<?php echo $this->get_field_name( 'htmloption' ); ?>">
                <?php _e( 'HTML Option:','mec-advanced-location' ); ?>
            </label>
