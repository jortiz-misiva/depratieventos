        ...
        <div class="mec-topsec mec-featured-top-sec">
                ...
                <div class="mec-featured-info-box">
                    ...
                    <p class="mec-featured-info">
                        ...
                        <span lass="mec-featured-info-box-title">
                            ...
                            <em class="mec-featured-title-count"><?php _e('Ongoing Events','mec-advanced-location'); ?>:</em>
                        ...
                        <span lass="mec-featured-info-box-title">
                            ...
                            <em class="mec-featured-title-count"><?php _e('All Events','mec-advanced-location'); ?>:</em>
            ...
            <div class="col-md-3 mec-col-table-c mec-event-meta-wrap mec-featured-meta-info mec-featured-text-top">
                <?php if($this->section=='location' && isset($meta['featured_map']) && $meta['featured_map']==1){
                    ...
                    echo $this->init_form_map($lat,$long);
                } else {
                ?>
                <div class="mec-event-meta ">
                    <?php if(isset($meta['featured']) && $meta['featured']==1): ?><div class="featured_list"><span class="mec-featured-box-top mec-featured-box-top-single mec-advanced-location-featured-custom <?php echo $this->atts['html_option'];?>"><?php _e('FEATURED','mec-advanced-location'); ?></span></div><?php endif; ?>
                    <p class="mec-featured-meta-box-list"><?php
