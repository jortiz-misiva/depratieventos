<?php
namespace MEC_Map\Core\checkLicense;
 ...
 * @since       1.0.0
 */
class AdvancedMapAddonUpdateActivation
{
     ...
     * @access  public
     */
    public $option_string = MECMAPOPTIONS;
     ...
     * @access  public
     */
    public $license_status_string = MECMAPTEXTDOMAIN . 'license_status';
     ...
     * @access  public
     */
    public $reActivation_string = MECMAPTEXTDOMAIN . 'reActivationOption';
     ...
     * @access  public
     */
    public $text_domain_string = MECMAPTEXTDOMAIN;
     ...
     * @access  public
     */
    public $main_file_path = MECMAPMAINFILEPATH;
    ...
    public static function setHooks($This){
        ...
        add_action(	'wp_ajax_activate_Addons_Integration_MAP', array($This, 'activate_Addons_Integration_MAP'));
    }
            ...
            if (jQuery("#'.$this->text_domain_string.'").length > 0)
            {
                jQuery("#'.$this->text_domain_string.' input[type=submit]").on("click", function(e){
                    ...
                    jQuery.ajax({
                        ...
                        type: "POST",
                        data: {
                            action: "activate_Addons_Integration_MAP",
    ...
    public function activate_Addons_Integration_MAP() {
        ...
        {
            $LicenseStatus = __('Activation failed. Please check your purchase code or license type.<br><b>Note: Your purchase code should match your licesne type.</b>', 'mec-map') . '<a style="text-decoration: underline; padding-left: 7px;" href="https://webnus.net/dox/modern-events-calendar/auto-update-issue/" target="_blank">'  . __('Troubleshooting', 'mec-map') . '</a>';
            update_option($this->license_status_string, 'faild');
        }
    ...
    public function load_auto_update() {
        ...
        require_once MECMAPPABSPATH.'/core/checkLicense/puc/plugin-update-checker.php';
